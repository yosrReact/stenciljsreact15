...
const domComponentCss = ".domComponent{display:block;border:1px solid black;background:lightgrey;padding:10px;margin:10px}.domComponent *{font-family:Arial, Helvetica, sans-serif}.domComponent h1{color:black}.domComponent .content{display:block;color:black;padding-top:10px;padding-bottom:10px}";
var DomComponentStyle0 = domComponentCss;
...
class DomComponent {
    ...
    render() {
        return (hAsync("div", { key: '74eda215478e4dbadebf47d2df215ca71770ca1d', class: "domComponent" }, hAsync("h1", { key: '93e0e336c28adf1124dfe2a255fb18eace7b4959' }, this.heading), hAsync("slot", { key: 'ff6fa541f808ecce49c71afbfd4234cc08e8b663', name: "header" }), hAsync("div", { key: 'c01b15856a3919579ef8fbf7d0c4223c6b655354', class: "content" }, hAsync("slot", { key: 'fe49bd2e2b717d19b745d940c2295b6d80441115' })), hAsync("slot", { key: '8bf279ebedd1a95201f54a68751958fec9f35e23', name: "footer" })));
    }
    static get style() { return DomComponentStyle0; }
...
const shadowComponentCss = ":host{--background-color:lightgrey;display:block;border:1px solid white;background:var(--background-color);padding:10px;max-width:80%;margin:auto}:host *{font-family:Arial, Helvetica, sans-serif}:host h2{color:black}:host .content{display:block;color:blue;padding-top:10px;padding-bottom:10px}";
var ShadowComponentStyle0 = shadowComponentCss;
...
class ShadowComponent {
    ...
    render() {
        return (hAsync(Host, { key: '45185f55c71020381312ff56e2e3acc3c5b14257' }, hAsync("h2", { key: '17b94c436c19b8dbdff51c2c393c1366c58fffd0' }, this.heading), hAsync("div", { key: '38071256999f9a1fe189b3dfba04b76c0e98fa4a', class: "content" }, hAsync("slot", { key: '39831be876142c30fcdb650e543bed1b06e13b6b' })), hAsync("slot", { key: '197f6f5599d29bc7515ff4f99d420295d9e99413', name: "footer" })));
    }
    static get style() { return ShadowComponentStyle0; }
    static get cmpMeta() { return {
        "$flags$": 9,
